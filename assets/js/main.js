...
const translations = {
  "en": {
    ...
    "hub": {
      ...
      "body": "Members can create accounts, publish updates, share social links and exchange direct messages inside a dedicated community page connected to the project workspace.",
    ...
    "community": {
      ...
      "setupNote": "Confirm your Supabase Project URL, publishable key and SQL setup if sign-in does not complete correctly.",
  ...
  "sl": {
    ...
    "hub": {
      ...
      "body": "Člani lahko ustvarijo račun, objavljajo novice, delijo družbena omrežja in si pošiljajo neposredna sporočila na posebni skupnostni strani, povezani s projektnim workspace sistemom.",
    ...
    "community": {
      ...
      "setupTitle": "Nastavitev workspace sistema",
      "setupNote": "Če prijava ne deluje pravilno, preveri Supabase URL, publishable key in SQL nastavitev.",
  ...
  "gr": {
    ...
    "hub": {
      ...
      "body": "Τα μέλη μπορούν να δημιουργούν λογαριασμούς, να δημοσιεύουν ενημερώσεις, να μοιράζονται κοινωνικούς συνδέσμους και να ανταλλάσσουν άμεσα μηνύματα σε ειδική σελίδα κοινότητας συνδεδεμένη με τον χώρο εργασίας του έργου.",
    ...
    "community": {
      ...
      "setupTitle": "Ρύθμιση χώρου εργασίας",
      "setupNote": "Επιβεβαιώστε το URL του Supabase, το publishable key και το SQL setup αν η σύνδεση δεν ολοκληρώνεται σωστά.",
  ...
  "ar": {
    ...
    "hub": {
      ...
      "body": "يمكن للأعضاء إنشاء حسابات ونشر التحديثات ومشاركة الروابط الاجتماعية وتبادل الرسائل المباشرة داخل صفحة مجتمع مخصصة المتصلة بمساحة عمل المشروع.",
    ...
    "community": {
      ...
      "setupTitle": "إعداد مساحة العمل",
      "setupNote": "تحقق من رابط Supabase والمفتاح العام وإعداد SQL إذا لم يكتمل تسجيل الدخول بشكل صحيح.",
