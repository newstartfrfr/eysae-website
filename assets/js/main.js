...
const translations = {
  "en": {
    ...
    "footer": {
      "tagline": "Official EYSAE project website presenting the partnership, activities, public updates and results.",
      "navTitle": "Navigation",
      "noteTitle": "Institutional Note",
      "noteBody": "EU-funded communication materials should present EU visibility clearly and accurately.",
    ...
    "home": {
      ...
      "heroDesc": "EYSAE brings together youth organisations and young participants around sustainable agriculture, entrepreneurship and practical learning across partner countries.",
    ...
    "about": {
      ...
      "body": "EYSAE responds to youth unemployment, weak support systems for young entrepreneurs and the need for greener local economies.",
      "reasonTitle": "Why this project matters",
      "reasonBody": "Many young people still lack access to practical training, entrepreneurial support and sustainable work opportunities.",
      "deliverTitle": "What EYSAE delivers",
      "deliverBody": "The project combines capacity-building, international mobility, local follow-up activities and digital resources for longer-term use."
    },
    "objectives": {
      "eyebrow": "Objectives",
      "title": "Project Objectives",
      "obj1Title": "Strengthen youth organisations",
      "obj1Body": "Equip youth workers and partner organisations with tools to support entrepreneurship, mentoring and non-formal learning.",
      "obj2Title": "Build practical skills for young people",
      "obj2Body": "Develop entrepreneurial, digital and financial skills that young people can use in real projects and future work.",
      "obj3Title": "Connect local action with international learning",
      "obj3Body": "Link study visits, training courses and exchanges with local workshops, outreach and follow-up activities.",
      "obj4Title": "Support sustainable business ideas",
      "obj4Body": "Promote green entrepreneurship, responsible production and climate-aware thinking through training and visibility work."
    },
    "partners": {
      "eyebrow": "Partnership",
    ...
    "news": {
      ...
      "n1Title": "Partnership planning and launch phase has started",
      "n1Body": "Partner organisations are confirming coordination routines, public visibility steps and the first implementation calendar.",
      "n2Meta": "March 2026 Mobility Preparation",
      "n2Title": "Preparation is underway for the first international activities",
      "n2Body": "The consortium is preparing participant outreach, logistics and working materials for upcoming study visits, training and exchange activities.",
      "n3Meta": "March 2026 Visibility",
      "n3Title": "Public website structure for project visibility is now in place",
      "n3Body": "The website now brings together core project information, partner presentation and a clear space for future news and results.",
      "readMore": "Read more",
    ...
    "contact": {
      ...
      "sideBody": "Updates will be added as activities, mobilities and dissemination outputs are completed.",
      "cta": "Send an Email"
    },
    "project": {
      "metaTitle": "EYSAE Project Page",
      "kicker": "Project overview",
      "title": "Why EYSAE exists and how it works",
      "body": "EYSAE responds to youth unemployment, weak support structures and the need for greener entrepreneurial pathways for young people.",
      ...
      "overviewTitle": "Project rationale",
      "overviewBody": "The project focuses on youth employability, sustainable entrepreneurship, organisational capacity and cross-border cooperation.",
      "clarityTitle": "What problem it addresses",
      "clarityBody": "Many young people lack access to training, financing pathways and practical support to develop sustainable livelihoods.",
      "architectureTitle": "What the partnership does",
      "architectureBody": "The consortium combines training, mobility, local action, digital tools and dissemination across partner countries.",
      "futureTitle": "What should remain after the project",
      "futureBody": "Training resources, stronger organisational capacity, better cooperation links and public-facing results.",
      "blocksEyebrow": "Core blocks",
      "blocksTitle": "Main work areas",
      "blocksBody": "The project can be explained clearly through four practical work areas.",
      "block1Title": "Background",
      "block1Body": "Explain the regional needs, the pressure on young people and the reason for focusing on sustainable entrepreneurship.",
      "block2Title": "Objectives",
      "block2Body": "Present the learning, organisational and cooperation objectives in clear and realistic terms.",
      "block3Title": "Activities",
      "block3Body": "Show the mix of study visits, training, exchanges and local follow-up activities.",
      "block4Title": "Results",
      "block4Body": "Highlight the digital resources, visibility outputs and longer-term use of project results.",
      "timelineEyebrow": "Implementation flow",
      "timelineTitle": "Implementation flow",
      "timelineBody": "The page should reflect the real flow of coordination, learning activities, local follow-up and dissemination.",
      "phase1Label": "Phase 1",
      "phase1Title": "Kick-off and coordination",
      "phase1Body": "Partners align roles, work plan, monitoring and visibility.",
      "phase2Label": "Phase 2",
      "phase2Title": "Study visits and training",
      "phase2Body": "International activities focus on entrepreneurship, digital skills and sustainability.",
      "phase3Label": "Phase 3",
      "phase3Title": "Local follow-up activities",
      "phase3Body": "Each partner translates international learning into workshops and community-based action.",
      "phase4Label": "Phase 4",
      "phase4Title": "Digital resources and dissemination",
      "phase4Body": "The project publishes materials, shares stories and presents results for longer-term use.",
