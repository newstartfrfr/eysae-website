...
const translations = {
  "en": {
    ...
    "footer": {
      "tagline": "Official website of EYSAE, presenting the project rationale, activities, partnership, results and public updates within the Erasmus+ cooperation framework.",
      "navTitle": "Navigation",
      "noteTitle": "Institutional Note",
      "noteBody": "This website serves as the public communication space of the EYSAE partnership and supports visibility, dissemination and access to project information.",
      "copyright": "© 2026 EYSAE",
      "disclaimer": "The content published here reflects the work of the EYSAE partnership and is provided for public information, project visibility and dissemination purposes."
    },
    "home": {
      ...
      "heroDesc": "EYSAE responds to youth unemployment, weak entrepreneurial support and environmental pressure by helping young people build practical skills in sustainable agriculture, green entrepreneurship and international cooperation.",
    ...
    "framework": {
      ...
      "body": "This website presents the public story of EYSAE: why the project exists, what challenges it addresses, how the partnership works and which activities, results and visibility actions are being delivered."
    },
    "hub": {
    ...
    "about": {
      "eyebrow": "Context",
      "title": "Context the Project",
      "body": "EYSAE is a capacity-building project focused on the Southern Mediterranean region. It helps young people and youth organisations develop entrepreneurial, digital and sustainability-related competences with a strong link to agriculture and green economic opportunities.",
      "reasonTitle": "Why this project matters",
      "reasonBody": "The project responds to high youth unemployment, limited access to quality training, underused agricultural potential and weak support structures for sustainable entrepreneurship, especially in rural and marginalised contexts.",
      "deliverTitle": "What EYSAE delivers",
      "deliverBody": "EYSAE combines training, study visits, youth exchange, local follow-up activities, digital resources and public dissemination so learning can move from international cooperation into local practice."
    },
    "objectives": {
      "eyebrow": "Objectives",
      "title": "Project Objectives",
      "obj1Title": "Strengthen the capacity of youth organisations",
      "obj1Body": "Equip youth organisations with methods, tools and cooperation models so they can better support young entrepreneurs and non-formal learning.",
      "obj2Title": "Build entrepreneurial and digital skills",
      "obj2Body": "Give young people practical skills in entrepreneurship, financial literacy, digital tools and sustainable business development.",
      "obj3Title": "Increase mobility, exchange and civic participation",
      "obj3Body": "Use transnational learning, study visits, exchange formats and civic engagement activities to connect youth, youth workers and stakeholders across countries.",
      "obj4Title": "Create lasting digital and public-facing results",
      "obj4Body": "Develop an online platform, media materials and dissemination outputs that keep knowledge accessible beyond the project lifecycle."
    },
    "partners": {
      "eyebrow": "Partnership",
    ...
    "news": {
      ...
      "body": "Follow official updates on launch, preparation, activities, visibility work and key implementation milestones across the partnership.",
      "n1Meta": "Launch and coordination",
      "n1Title": "Project implementation officially begins",
      "n1Body": "The partnership has completed its first coordination phase and aligned the implementation logic, visibility direction and working priorities for the opening stage of EYSAE.",
      "n2Meta": "Activity preparation",
      "n2Title": "Preparations for international learning activities are underway",
      "n2Body": "Partners are preparing study visits, training activities and participant support materials so international learning can translate into strong local follow-up work.",
      "n3Meta": "Visibility and outreach",
      "n3Title": "Website visibility framework is now in place",
      "n3Body": "The website now offers a cleaner public structure for presenting the project rationale, partnership, updates and dissemination materials in a consistent institutional format.",
      "readMore": "Read more",
    ...
    "project": {
      ...
      "body": "This page explains the project in a more complete way: the challenge it addresses, the objectives it pursues, the methodology it uses and the type of results it aims to leave behind.",
      ...
      "overviewTitle": "Project rationale and purpose",
      "overviewBody": "EYSAE addresses youth unemployment, limited entrepreneurial support and environmental pressure by linking youth work, sustainable entrepreneurship, digital learning and international cooperation.",
      "clarityTitle": "Why the project is relevant",
      "clarityBody": "The proposal is rooted in a needs analysis focused on employment barriers, weak support structures, low civic participation and limited awareness of sustainable production and consumption.",
      "architectureTitle": "What the project is trying to change",
      "architectureBody": "It aims to strengthen youth organisations, build practical entrepreneurial skills, improve civic participation and create durable digital resources and visibility outputs.",
      "futureTitle": "What stays after the activities",
      "futureBody": "The long-term ambition is continued access to training resources, stronger cooperation links, mentorship pathways and wider use of sustainable entrepreneurship methods.",
      "blocksEyebrow": "Core blocks",
      "blocksTitle": "Main project content",
      "blocksBody": "The project can be presented through four grounded blocks that feel real to visitors and evaluators alike.",
      "block1Title": "Context",
      "block1Body": "Explain the regional challenges, the youth dimension and why sustainable agriculture and entrepreneurship matter in this context.",
      "block2Title": "Objectives",
      "block2Body": "Keep the objectives practical: stronger youth organisations, better skills, more civic participation and durable digital outputs.",
      "block3Title": "Activities",
      "block3Body": "Describe study visits, training courses, youth exchange, local follow-up workshops and digital dissemination work.",
      "block4Title": "Results",
      "block4Body": "Show the platform, learning resources, media outputs, new cooperation routines and the public visibility trail created by the partnership.",
      "timelineEyebrow": "Implementation flow",
      "timelineTitle": "Implementation logic",
      "timelineBody": "The proposal describes a step-by-step methodology that can be shown as a clean implementation path for visitors.",
      "phase1Label": "Phase 1",
      "phase1Title": "Foundation and strategic planning",
      "phase1Body": "Kick-off coordination, work distribution, quality assurance setup and thematic alignment across the consortium.",
      "phase2Label": "Phase 2",
      "phase2Title": "Knowledge exchange and local action",
      "phase2Body": "Study visits, training sessions and local follow-up workshops transfer learning into practice inside each partner country.",
      "phase3Label": "Phase 3",
      "phase3Title": "Mobility and international exchange",
      "phase3Body": "International activities connect youth workers and participants through thematic exchange, best-practice sharing and applied learning.",
      "phase4Label": "Phase 4",
      "phase4Title": "Digitalisation, visibility and sustainability",
      "phase4Body": "The project extends its reach through digital resources, media content, public communication and long-term access to results.",
